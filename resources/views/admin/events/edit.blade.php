...
<div class="max-w-3xl">
    ...
    <div class="bg-white rounded-xl shadow p-6">
        <h2 class="text-lg font-semibold text-gray-800 mb-6">Edit Event</h2>
        ...
        <form action="{{ route('admin.events.update', $event) }}" method="POST"
            ...
            <div>
                ...
                <textarea name="description" rows="5"
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 @error('description') border-red-400 @enderror">{{ old('description', $event->description) }}</textarea>
            ...
            <div>
                ...
                @if($event->image)
                    <img src="{{ asset('storage/' . $event->image) }}" id="imagePreview"
                        class="w-48 h-32 object-cover rounded-lg border mb-2" alt="Gambar saat ini">
                @else
                    <img id="imagePreview" src="" class="w-48 h-32 object-cover rounded-lg border mb-2 hidden">
                @endif
            ...
            <div class="flex items-center gap-3">
                ...
                <label for="is_active" class="text-sm text-gray-700">Aktifkan event ini</label>
            </div>
